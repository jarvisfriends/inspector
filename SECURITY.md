...
Please use
[GitHub's private vulnerability reporting](https://github.com/jarvisfriends/inspector/security)
...
- We publish an advisory through
  [GitHub Security Advisories](https://github.com/jarvisfriends/inspector/security) when the fix
